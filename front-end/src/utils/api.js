...
export async function createReservation(newTable, signal) {
...
export async function updateTable(id, reservation_id, signal) {
...
export async function finishTable(id, signal) {
  const url = `${API_BASE_URL}/tables/${id}/seat`;
  const options = {
    method: "DELETE",
    headers,
